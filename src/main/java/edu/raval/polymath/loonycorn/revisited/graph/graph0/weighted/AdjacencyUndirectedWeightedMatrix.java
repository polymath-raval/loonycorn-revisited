...
public class AdjacencyUndirectedWeightedMatrix  implements IWeightedGraph {

  private final boolean[][] presentMatrix;
  private final int[][] weightMatrix;

  public AdjacencyUndirectedWeightedMatrix(int numberOfVertices) {
  ...
  public void addEdge(int sourceVertex, WeightedNode destinationVertex) {
    ...
    presentMatrix[destinationVertex.destinationNode][sourceVertex] = true;
    weightMatrix[destinationVertex.destinationNode][sourceVertex] = destinationVertex.weight;
  }
