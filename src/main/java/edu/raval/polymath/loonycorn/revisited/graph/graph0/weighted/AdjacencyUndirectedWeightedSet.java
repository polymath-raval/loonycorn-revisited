...
public class AdjacencyUndirectedWeightedSet implements IWeightedGraph {
  ...
  public void addEdge(int sourceVertex, WeightedNode destinationVertex) {
    ...
    adjacencySet.putIfAbsent(destinationVertex.destinationNode, new HashSet<>());
    adjacencySet.get(destinationVertex.destinationNode)
        .add(new WeightedNode(sourceVertex, destinationVertex.weight));
  }
